...
class ArrayAdapter{
 ...
 const MongoVehicleMain = async ()=>{
    try {
        ...
        console.log(await vehicle.save(1,'Honda'));
        console.log(await vehicle.save(2,'Ford'));
        console.log(await vehicle.save(3,'Bmw'));
        console.log(await vehicle.show());
        console.log(await vehicle.update(1,'Tata'));
        console.log(await vehicle.show());
        adapt.close();
    } catch (err) {
        console.log(err);   
